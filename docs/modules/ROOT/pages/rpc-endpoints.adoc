...
// URLs
// Project URLs
:url_advanced_communication_aliases: ROOT::understand-blockchain/endpoints.adoc#aliases
:url_modules_dpos: modules/dpos-module.adoc
:url_plugins_faucet: plugins/faucet-plugin.adoc
:url_plugins_forger: plugins/forger-plugin.adoc
:url_plugins_report_misbehavior: plugins/report-misbehavior-plugin.adoc
:url_plugins_monitor: plugins/monitor-plugin.adoc
