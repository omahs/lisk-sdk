...
:url_protocol_blocks_rewards: ROOT::lisk-protocol/blocks.adoc#rewards_and_fees
:url_protocol_dpos: ROOT::lisk-protocol/consensus-algorithm.adoc#dpos
:url_protocol_bft: ROOT::lisk-protocol/consensus-algorithm.adoc#lisk_bft
:url_protocol_delegate_selection: ROOT::lisk-protocol/consensus-algorithm.adoc#delegate_selection
:url_protocol_fork_choice: ROOT::lisk-protocol/consensus-algorithm.adoc#index-fork_choice_rule-1
:url_protocol_punishment: ROOT::lisk-protocol/consensus-algorithm.adoc#punishment
:url_protocol_transactions_pom: ROOT::lisk-protocol/transactions.adoc#pom
:url_protocol_transactions_delegate: ROOT::lisk-protocol/transactions.adoc#delegate
:url_protocol_transactions_unlock: ROOT::lisk-protocol/transactions.adoc#unlock
:url_protocol_transactions_vote: ROOT::lisk-protocol/transactions.adoc#vote
