...
:idprefix:
// Project URLs
:url_aes_glossary: ROOT:glossary.adoc#aes-256-cbc-advanced-encryption-standard
...
VERSION
  lisk-commander/5.1.7 darwin-x64 node-v12.20.1
...
Displays the Network identifier based on the payloadhash of the genesis block of the network.
